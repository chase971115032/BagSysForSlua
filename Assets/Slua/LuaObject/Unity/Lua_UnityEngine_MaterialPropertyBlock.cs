...
public class Lua_UnityEngine_MaterialPropertyBlock : LuaObject {
	...
	static public int AddFloat(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function AddFloat to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int AddVector(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function AddVector to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int AddColor(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function AddColor to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int AddMatrix(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function AddMatrix to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int AddTexture(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function AddTexture to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
