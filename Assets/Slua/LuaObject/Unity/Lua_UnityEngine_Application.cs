...
public class Lua_UnityEngine_Application : LuaObject {
	...
	static public int LoadLevelAsync_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function LoadLevelAsync to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int LoadLevelAdditiveAsync_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function LoadLevelAdditiveAsync to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int LoadLevelAdditive_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function LoadLevelAdditive to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
